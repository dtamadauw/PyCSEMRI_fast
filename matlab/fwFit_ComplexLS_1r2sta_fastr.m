function outParams = fwFit_ComplexLS_1r2star(imDataParams, algoParams, initParams)
...
if ~isfield(initParams, 'fm_init') || ~isfield(initParams, 'r2s_init')
...
[wat_r, wat_i, fat_r, fat_i, r2starmap, fm] = fwFit_ComplexLS_1r2star_mex(...
    imData, algo, init);
