...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    init_c.water_r_init = (double*)mxGetData(get_field(init_mx, "water_r_init"));
    init_c.fat_r_init = (double*)mxGetData(get_field(init_mx, "fat_r_init"));
    init_c.water_i_init = (double*)mxGetData(get_field(init_mx, "water_i_init"));
    init_c.fat_i_init = (double*)mxGetData(get_field(init_mx, "fat_i_init"));
    ...
    mexPrintf("Calling libuwwfs: fwFit_MagnLS_1r2star_c...\n");
    fwFit_MagnLS_1r2star_c(&imData_c, &algo_c, &init_c, &out_c);
