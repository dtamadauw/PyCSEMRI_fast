...
def fwFit_VarproLS_1r2star(imDataParams, algoParams, initParams):
	...
	libuwwfs.fwFit_VarproLS_1r2star_c.argtypes = [ctypes.POINTER(ImDataParams_str), ctypes.POINTER(AlgoParams_str), ctypes.POINTER(InitParams_str), ctypes.POINTER(OutParams_str)]
	libuwwfs.fwFit_VarproLS_1r2star_c.restype = None
	libuwwfs.fwFit_VarproLS_1r2star_c(ctypes.byref(imDataParams_c), ctypes.byref(algoParams_c), ctypes.byref(initParams_c), ctypes.byref(outParams_c))
